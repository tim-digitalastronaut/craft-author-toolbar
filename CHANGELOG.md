...
- Added a config option to disable the environment message [#11](https://github.com/tim-digitalastronaut/craft-author-toolbar/issues/11), [#10](https://github.com/tim-digitalastronaut/craft-author-toolbar/issues/10),
- Minor bugfixes
