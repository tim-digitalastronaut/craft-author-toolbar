  ...
  return {
    init: function init() {
      ...
      var updatePosition = function updatePosition() {
        (0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_0__.computePosition)(anchor, menu, {
          placement: "top-start",
      ...
      (0,_floating_ui_dom__WEBPACK_IMPORTED_MODULE_0__.autoUpdate)(anchor, menu, updatePosition);
    }
  };
}
...
/***/ "./src/web/assets/src/js/seoChecklist.js":
/*!***********************************************!*\
  !*** ./src/web/assets/src/js/seoChecklist.js ***!
  \***********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/web/assets/src/js/seoPreviews.js":
/*!**********************************************!*\
  !*** ./src/web/assets/src/js/seoPreviews.js ***!
  \**********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   getSeoMeta: () => (/* binding */ getSeoMeta)
/* harmony export */ });
...
var getMeta = function getMeta(selector) {
  var meta = document.querySelector(selector);
  return meta ? meta.getAttribute("content") : "";
};
var getSeoMeta = function getSeoMeta() {
  ...
  var ogTitle = getMeta('meta[property="og:title"]') || title;
  var ogDescription = getMeta('meta[property="og:description"]') || description;
  var ogImage = getMeta('meta[property="og:image"]') || "";
  var ogUrl = getMeta('meta[property="og:url"]') || canonical;
  var ogType = getMeta('meta[property="og:type"]') || "website";
  var ogSiteName = getMeta('meta[property="og:site_name"]') || "";
  var twitterCard = getMeta('meta[name="twitter:card"]') || "summary";
  var twitterTitle = getMeta('meta[name="twitter:title"]') || ogTitle;
  var twitterDescription = getMeta('meta[name="twitter:description"]') || ogDescription || description;
  var twitterImage = getMeta('meta[name="twitter:image"]') || ogImage;
  var twitterUrl = getMeta('meta[name="twitter:url"]') || canonical;
  var twitterSite = getMeta('meta[name="twitter:site"]') || "";
  var twitterCreator = getMeta('meta[name="twitter:creator"]') || "";
  return {
    language: language,
    favicon: favicon,
    og: {
...
function toolbar() {
  return {
    ...
    init: function init() {
      ...
      menus.forEach(function (menu) {
        _this.$watch(menu, function (value) {
          if (value) menus.filter(function (menu) {
            return menu !== menu;
          }).forEach(function (menu) {
            return _this[menu] = false;
          });
        });
      });
    },
    getSeoChecklist: function getSeoChecklist() {
      ...
      this.passedSeoChecks = this.seoChecklistResults.filter(function (check) {
        return check.status == "passed";
      }).length;
      this.overallSeoStatus = "passed";
      if (this.seoChecklistResults.some(function (check) {
        return check.status === "warning";
      })) this.overallSeoStatus = "warning";
      if (this.seoChecklistResults.some(function (check) {
        return check.status === "failed";
      })) this.overallSeoStatus = "failed";
    },
    getSeoPreviews: function getSeoPreviews() {
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
        var seoMeta, _yield$templateReques, content;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 1:
              _yield$templateReques = _context.v;
    ...
    getImagesOverview: function getImagesOverview() {
      var _this2 = this;
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
        ...
        return _regenerator().w(function (_context2) {
          while (1) switch (_context2.p = _context2.n) {
            ...
            case 11:
              _this2.images = imagesData;
            case 12:
              return _context2.a(2);
          }
        }, _callee2, null, [[3, 5], [1, 9, 10, 11]]);
      }))();
    },
    getHeadingsOverview: function getHeadingsOverview() {
      ...
      this.headings = filledHeadings.map(function (heading) {
    ...
    renderSearchResults: function renderSearchResults() {
      ...
      return _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
        var queryString, _yield$templateReques2, content;
    ...
    copyToPageURLToClipboard: function copyToPageURLToClipboard() {
    ...
    showElementOnPage: function showElementOnPage(element) {
      ...
      setTimeout(function () {
        return element.classList.remove("show-on-page");
      }, 1000);
