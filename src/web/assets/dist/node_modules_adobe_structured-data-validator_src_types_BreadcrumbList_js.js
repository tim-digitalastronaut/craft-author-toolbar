"use strict";
(self["webpackChunkcraft_author_toolbar"] = self["webpackChunkcraft_author_toolbar"] || []).push([["node_modules_adobe_structured-data-validator_src_types_BreadcrumbList_js"],{
...
/* harmony export */   "default": () => (/* binding */ BreadcrumbListValidator)
/* harmony export */ });
...
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils.js */ "./node_modules/@adobe/structured-data-validator/src/utils.js");
/**
...
class BreadcrumbListValidator extends _base_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getConditions() {
    return [
  ...
  atLeastTwoItems(data) {
    if (
      ...
      (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(data['itemListElement'])
    ) {
      return {
  ...
  validateItemUrl(data) {
    ...
    } else if ((0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.isObject)(data['itemListElement'])) {
      items.push(data['itemListElement']);
    }
