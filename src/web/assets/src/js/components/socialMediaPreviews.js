export class SocialMediaPreviews extends HTMLElement {
	...
	connectedCallback() {
		this.tabElements = [
			...this.getElementsByClassName("cat-toolbar-seo-menu-previews-results-option-tabs-item-button"),
		];
	...
	changeTab(tab) {
		...
		this.element.querySelectorAll(`[data-tab-content]`).forEach((tabContent) => {
