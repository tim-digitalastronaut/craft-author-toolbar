...
class SeoMenu extends BaseMenu {
	...
	async renderChecklist() {
		...
		this.toggleStatusElement.querySelector(".seo-menu-toggle-status-summary").innerText =
	...
	changeTab(tab) {
		...
		this.menuElement
			.querySelectorAll(".cat-toolbar-seo-menu-tab-content > [data-tab-content]")
			.forEach((tabContent) => {
				tabContent.classList.remove("active");
			});

		this.menuElement
			.querySelector(`.cat-toolbar-seo-menu-tab-content > [data-tab-content="${tab}"]`)
